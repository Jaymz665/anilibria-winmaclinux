...
Popup {
    ...
    DictionaryComboBox {
        ...
        onActivated: {
            releasesViewModel.imageBackgroundViewModel.imageModes.selectedItem = currentIndex;
        }
    }
    ...
    DictionaryComboBox {
        ...
        onActivated: {
            releasesViewModel.imageBackgroundViewModel.alignmentModes.selectedItem = currentIndex;
        }
    }
    ...
    function setupComboboxes() {
        imageModesComboBox.currentIndex = releasesViewModel.imageBackgroundViewModel.imageModes.selectedItem;
        aligmentComboBox.currentIndex = releasesViewModel.imageBackgroundViewModel.alignmentModes.selectedItem;
    }
